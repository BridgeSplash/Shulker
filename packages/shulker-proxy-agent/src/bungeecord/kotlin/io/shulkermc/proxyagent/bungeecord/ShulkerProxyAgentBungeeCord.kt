...
import io.shulkermc.proxyagent.bungeecord.commands.GlobalShutdownCommand
...
class ShulkerProxyAgentBungeeCord : Plugin() {
    ...
    override fun onEnable() {
        ...
        this.proxy.pluginManager.registerCommand(this, GlobalShutdownCommand(this.agent, this.adventure))
    }
